...
class ProductLoader {
  ...
  getSampleProducts() {
    return [
      ...
      { id: 17, name: "Jeruk", price: 5000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/es_cendol.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 18, name: "Air Mineral Kecil", price: 4000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/americano.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 19, name: "Air Mineral Besar", price: 6000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/americano.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 22, name: "Lemon Tea", price: 10000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/americano.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 24, name: "Teh Sharing (5 orang)", price: 20000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/kopi_susu_gula_aren.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 211, name: "Teh Hangat", price: 4000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/tehhangat.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 212, name: "Es Jeruk", price: 6000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/esjeruk.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
  ...
  renderCard(product, index) {
      ...
      <article class="menu-card menu-item-card" 
        ...
        <div class="menu-photo">
          <img src="../assets/${product.image || 'placeholder.jpg'}" 
