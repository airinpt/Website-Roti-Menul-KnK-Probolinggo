...
class ProductLoader {
  ...
  getSampleProducts() {
    return [
      ...
      { id: 8, name: "Kentang", price: 8000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/kentang.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 11, name: "Nuget (5pcs)", price: 10000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/nuget.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 14, name: "Mix Platter", price: 15000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/mix_platter.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 16, name: "Teh", price: 4000, brand_id: 1, brand_name: "MieeNull", image: "foto_produk_mieenull/teh.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 210, name: "Es Teh (Free)", price: 0, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/es_teh.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      ...
      { id: 213, name: "Air Mineral Kecil", price: 4000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/air_mineral_kecil.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 214, name: "Air Mineral Besar", price: 6000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/air_mineral_besar.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 220, name: "Kerupuk Udang", price: 1000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/kerupuk_udang.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 221, name: "Kerupuk Putih", price: 2000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/kerupuk_putih.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] },
      { id: 222, name: "Kerupuk Kulit", price: 7000, brand_id: 3, brand_name: "Teras Menull", image: "foto_produk_teras/kerupuk_kulit.jpeg", enable_serving: false, packaging_fee: 0, has_variants: false, has_extras: false, is_package: false, variants: [], extras: [], additional_items: [], package_items: [] }
